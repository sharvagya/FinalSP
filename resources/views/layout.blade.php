...
<html lang="en">
    ...
    <body class="sb-nav-fixed">
        <nav class="sb-topnav navbar navbar-expand navbar-dark bg-dark">
            <!-- Navbar Brand-->
            <a class="navbar-brand ps-3" href="index.html">Model Constructions</a>
            <!-- Sidebar Toggle-->
            ...
            <div id="layoutSidenav_nav">
                <nav class="sb-sidenav accordion sb-sidenav-dark" id="sidenavAccordion">
                        ...
                        <div class="nav">
                            ...
                            <div class="collapse" id="collapsePages" aria-labelledby="headingTwo" data-bs-parent="#sidenavAccordion">
                                <nav class="sb-sidenav-menu-nested nav">
                                    ...
                                    <a class="nav-link" href="{{url('employees/create')}}">Add new</a>
                                </nav>
                           ...
                           {{-- Attendance --}}
                            <a class="nav-link collapsed" href="#" data-bs-toggle="collapse" data-bs-target="#collapseAttendance" aria-expanded="false" aria-controls="collapseAttendance">
                                ...
                                <div class="collapse" id="collapseAttendance" aria-labelledby="headingAttendance" data-bs-parent="#sidenavAccordion">
                                     <nav class="sb-sidenav-menu-nested nav">
                                        <a class="nav-link" href="{{ url('attendance/sheet') }}">Attendance Sheet</a>
                                        <a class="nav-link" href="{{ url('attendance/report') }}">Sheet Report</a>
                                        <a class="nav-link" href="{{ url('attendance/log') }}">Attendance Log</a>
                    ...
                    <div class="sb-sidenav-footer">
                        ...
                        {{-- {{ Auth::admins()->firstname }} --}}Jimmy123
                    </div>
                </nav>
            </div>
