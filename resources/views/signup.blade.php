                                ...
                                <div class="card shadow-lg border-0 rounded-lg mt-5">
                                    ...
                                    <div class="card-body">
                                        <form action="{{ route('signup.post') }}" method="post">
                                            ...
                                            <div class="mt-4 mb-0">
                                                <input type="submit" value="Submit" style="width: 100%; background-color: #007bff; color: #fff; padding: 10px 20px; border: none; border-radius: 4px; font-size: 16px; cursor: pointer;">
